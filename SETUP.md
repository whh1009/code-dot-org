...
You can do Code.org development using OSX, Ubuntu, or Windows (running Ubuntu in WSL or a VM). Setup for Windows is more complicated and relatively few developers use it. Make sure you follow the instructions for your platform in the subsections below.
