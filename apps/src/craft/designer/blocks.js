...
export const install = (blockly, blockInstallOptions) => {
  ...
  blockly.Generator.craft_entityTurn = function() {
  ...
  blockly.Generator.craft_entityTurnLR = function() {
    // Generate JavaScript for turning left or right.
    const dir = this.getTitleValue('DIR');
    const methodCalls = {
      left: 'turnLeft',
  ...
  blockly.Generator.craft_turn = function() {
    // Generate JavaScript for turning left or right.
    const dir = this.getTitleValue('DIR');
  ...
  function generatorFor(blockType, statementNames = defaultEventOrder) {
    return function() {
      return statementNames
        .map(statementName => {
          const callback = blockly.Generator.statementToCode(
            this,
            statementName
          ).replace(/\n/g, '');
  ...
  function createEventBlockForEntity(entityID, displayName) {
    ...
    blockly.Generator[`craft_${entityID}`] = generatorFor(entityID);
  }
  ...
  function createLimitedEventBlockForEntity(
    ...
    blockly.Generator[`craft_${entityID}`] = generatorFor(
      entityType,
      statementNames
    );
  }
  ...
  function makeGlobalEventBlock(functionName, text, eventType) {
    ...
    blockly.Generator[`craft_${functionName}`] = function() {
      const callback = blockly.Generator.statementToCode(this, 'DO').replace(
        /\n/g,
        ''
      );
  ...
  function dropdownEntityBlock(
    ...
    blockly.Generator[`craft_${simpleFunctionName}`] = function() {
  ...
  function entityTargetActionBlock(
    ...
    blockly.Generator[`craft_${blockName}`] = function() {
  ...
  blockly.Generator.craft_forever = function() {
    const innerCode = blockly.Generator.statementToCode(this, 'DO');
  ...
  blockly.Generator.craft_repeatTimes = function() {
  ...
  blockly.Generator.craft_repeatRandom = function() {
    const innerCode = blockly.Generator.statementToCode(this, 'DO');
  ...
  blockly.Generator.craft_repeatDropdown = function() {
    const times = this.getTitleValue('TIMES');
    const innerCode = blockly.Generator.statementToCode(this, 'DO');
    return `repeat('block_id_${
      this.id
  ...
  blockly.Generator[`craft_spawnEntity`] = function() {
  ...
  blockly.Generator[`craft_spawnEntityRandom`] = function() {
    const type = this.getTitleValue('TYPE');
  ...
  blockly.Generator.craft_moveEntityNorth = function() {
  ...
  blockly.Generator.craft_moveEntitySouth = function() {
  ...
  blockly.Generator.craft_moveEntityEast = function() {
  ...
  blockly.Generator.craft_moveEntityWest = function() {
  ...
  blockly.Generator.craft_playSound = function() {
  ...
  blockly.Generator.craft_addScore = function() {
