  ...
  scriptData.stages.forEach(stage => {
    stage.levels.forEach(level => {
      students.forEach(student => {
        ...
        statuses[student.id][level.id] = randomStatus();
      });
    });
  });
  return {
    scriptDataByScript: {[scriptData.id]: scriptData},
    studentLevelProgressByScript: {[scriptData.id]: statuses},
...
function randomStatus() {
  ...
  switch (rand) {
    case 0:
      return {status: 'perfect', result: 100, time_spent: 5};
    case 1:
      return {status: 'attempted', result: 50, time_spent: 3};
    default:
      return {status: 'not_tried', result: 0, time_spent: 0};
  }
}
