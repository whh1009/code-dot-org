...
import EditSectionForm, {RefreshAfterEditSectionForm} from './EditSectionForm';
...
export const RefreshAfterEditSectionDialog = connect(state => ({
  isOpen: isEditingSection(state.teacherSections)
}))(editSectionDialog(RefreshAfterEditSectionForm));
