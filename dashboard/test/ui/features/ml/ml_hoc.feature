Feature: Oceans ML HoC
  ...
  Scenario: Fish vs. Trash
    ...
    Then I click selector "button:contains(Fish):eq(1)" 300 times
    Then I click selector "button:contains(Not Fish)" 300 times
  ...
  Scenario: Sea Creatures
    ...
    Then I click selector "button:contains(Yes)" 300 times
    Then I click selector "button:contains(No)" 300 times
    Then I click selector "button:contains(Continue)" once I see it
  ...
  Scenario: Short Word List
    ...
    Then I click selector "button:contains(Blue):eq(1)" 300 times
    Then I click selector "button:contains(Not Blue)" 300 times
    Then I click selector "button:contains(Continue)" once I see it
  ...
  Scenario: Long Word List
    ...
    Then I click selector "button:contains(Fierce):eq(1)" 300 times
    Then I click selector "button:contains(Not Fierce)" 300 times
    Then I click selector "button:contains(Continue)" once I see it
